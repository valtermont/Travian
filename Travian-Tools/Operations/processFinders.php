...
function getAlliance($alliance,$dist){
    ...
    echo 'Finding '.$alliance.' alliance member villages in the range of '.$dist;
    
}
?>

<?php 
function getNeighbours($Xcor,$Ycor, $dist){
    echo 'Finding Neighbours of '.$Xcor.'|'.$Ycor.' in range of '.$dist.'</br>';
...
function getPlayer($player){
    echo 'List of all the villages of '.$player;
